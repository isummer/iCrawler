...
public class TSpider {
	...
	public static TSpider connect(String url) throws IOException {
		TSpider connection = new TSpider();
		connection.setTargetUrl(url);
		return connection;
	}

	public TSpider header(String key, String value) {
		if(headers == null) {
	...
	public TSpider header(Map<String, String> headers) {
		this.headers = headers;
		return this;
	}
	
	public TSpider cookie(String cookie) {
		this.cookie = cookie;
		cookie("Cookie", cookie);
		return this;
	}
	
	public TSpider cookie(String name, String value) {
		if(cookies == null) {
	...
	public TSpider data(Map<String, String> params) {
		this.params = params;
		return this;
	}
